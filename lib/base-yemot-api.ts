...
import type { method, YemotApiError, string_object } from './types';
import { FileForUpload } from './file-for-upload';

type upload_file_parameters = {
	path: string,
	convertAudio: 0 | 1,
...
export class BaseYemotApi {
	...
	constructor(username: string, password: string, axios_config: AxiosRequestConfig = {}, ym_server = "ym") {
